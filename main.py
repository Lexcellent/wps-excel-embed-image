...
def embed_image(excel_path: str, cell_address: str, image_path: str):
    # 解压excel
    ...
    # ID = add_new_node(image_path, unzip_file_path)
    # zip_file(unzip_file_path, "new.xlsx")
    # logger.debug(ID)


def main():
    embed_image("old.xlsx", "C2", "test01.jpg")
